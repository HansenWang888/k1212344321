...
typedef NS_ENUM(SInt32, BuddyListCmdID) {
  ...
  BuddyListCmdIDCidBuddyListSearchUserRequest = 544,
  BuddyListCmdIDCidBuddyListSearchUserResponse = 545,
  BuddyListCmdIDCidBuddyListSubscribemenuinfoRequest = 546,
  BuddyListCmdIDCidBuddyListSubscribemenuinfoRespone = 547,
  BuddyListCmdIDCidAddFriendRequest = 560,
  BuddyListCmdIDCidAddFriendRespone = 561,
  BuddyListCmdIDCidAddFriendNotify = 562,
  BuddyListCmdIDCidAcceptFriendRequest = 563,
  BuddyListCmdIDCidAcceptFriendRespone = 564,
  BuddyListCmdIDCidAcceptFriendNotift = 565,
  BuddyListCmdIDCidBuddyListVerifyRequest = 576,
  BuddyListCmdIDCidBuddyListVerifyRespone = 577,
  BuddyListCmdIDCidBuddyDenialVerifyRequest = 578,
  BuddyListCmdIDCidModifyContactRequest = 593,
  BuddyListCmdIDCidModifyContactRespone = 594,
  BuddyListCmdIDCidModifyUserinfoRequest = 609,
  BuddyListCmdIDCidModifyUserinfoRespone = 610,
  BuddyListCmdIDCidNewuserinfoRequest = 625,
  BuddyListCmdIDCidNewuserinfoRespone = 626,
  BuddyListCmdIDCidSyncUserRequest = 641,
  BuddyListCmdIDCidSyncUserRespone = 642,
  BuddyListCmdIDCidReportSessionRequest = 657,
  BuddyListCmdIDCidBuddyListSubscribeAttentionRequest = 672,
  BuddyListCmdIDCidBuddyListSubscribeAttentionRespone = 673,
  BuddyListCmdIDCidBuddyListSubscribeInfoRequest = 674,
  BuddyListCmdIDCidBuddyListSubscribeInfoRespone = 675,
  BuddyListCmdIDCidBuddyListListSubscribeInfoRequest = 676,
  BuddyListCmdIDCidBuddyListListSubscribeInfoRespone = 677,
  BuddyListCmdIDCidBuddyListSearchSubscribeRequest = 678,
  BuddyListCmdIDCidBuddyListSearchSubscribeResponse = 679,
};
...
typedef NS_ENUM(SInt32, MessageCmdID) {
  ...
  MessageCmdIDCidScubscribeHttpMsgRequest = 784,
  MessageCmdIDCidScubscribeHttpMsgRespone = 785,
  MessageCmdIDCidMsgDataPush = 786,
};
...
typedef NS_ENUM(SInt32, GroupCmdID) {
  ...
  GroupCmdIDCidGroupInfoChangeRequest = 1280,
  GroupCmdIDCidGroupInfoChangeRespone = 1281,
  GroupCmdIDCidGroupInfoChangeNotify = 1282,
  GroupCmdIDCidHttpChangeGroupCreatorRequest = 1296,
  GroupCmdIDCidHttpChangeGroupCreatorRespone = 1297,
  GroupCmdIDCidHttpListContactGroupInfoRequest = 1313,
  GroupCmdIDCidHttpListContactGroupInfoRespone = 1314,
};
...
typedef NS_ENUM(SInt32, OtherCmdID) {
  ...
  OtherCmdIDCidOtherPingReq = 1857,
  OtherCmdIDCidOtherPingRsp = 1858,
};
...
typedef NS_ENUM(SInt32, UserModifyType) {
  UserModifyTypeAvatar = 0,
  UserModifyTypeNick = 1,
  UserModifyTypePs = 2,
  UserModifyTypeRemark = 3,
  UserModifyTypeTelphone = 4,
  UserModifyTypeEmail = 5,
};
...
typedef NS_ENUM(SInt32, SessionType) {
  ...
  SessionTypeSessionTypeSubscription = 3,
};
...
typedef NS_ENUM(SInt32, MsgType) {
  ...
  MsgTypeMsgTypeSingleShare = 4,
  MsgTypeMsgTypeSingleLog = 5,
  MsgTypeMsgTypeSingleRichtext = 6,
  MsgTypeMsgTypeSingleVideo = 7,
  MsgTypeMsgTypeSingleDoc = 8,
  MsgTypeMsgTypeSingleInvite = 9,
  MsgTypeMsgTypeGroupText = 17,
  MsgTypeMsgTypeGroupAudio = 18,
  MsgTypeMsgTypeGroupImage = 19,
  MsgTypeMsgTypeGroupShare = 20,
  MsgTypeMsgTypeGroupLog = 21,
  MsgTypeMsgTypeGroupRichtext = 22,
  MsgTypeMsgTypeGroupVideo = 23,
  MsgTypeMsgTypeGroupDoc = 24,
  MsgTypeMsgTypeGroupInvite = 25,
  MsgTypeMsgTypeSubscriptionText = 257,
  MsgTypeMsgTypeSubscriptionAudio = 258,
  MsgTypeMsgTypeSubscriptionImage = 259,
  MsgTypeMsgTypeSubscriptionShare = 260,
  MsgTypeMsgTypeSubscriptionLog = 261,
  MsgTypeMsgTypeSubscriptionRichtext = 262,
  MsgTypeMsgTypeSubscriptionVideo = 263,
  MsgTypeMsgTypeSubscriptionDoc = 264,
  MsgTypeMsgTypeSubscriptionInvite = 265,
};
...
typedef NS_ENUM(SInt32, GroupModifyType) {
  ...
  GroupModifyTypeGroupModifyTypeNewname = 3,
  GroupModifyTypeGroupModifyTypeNewusernick = 4,
  GroupModifyTypeGroupModifyTypeQuit = 5,
};
...
typedef NS_ENUM(SInt32, VerifyRet) {
  VerifyRetVerifyOk = 0,
  VerifyRetVerifyAlreadyInContact = 1,
  VerifyRetVerifyDbError = 2,
  VerifyRetVerifyTimeout = 3,
  VerifyRetVerifyNoverify = 4,
};
...
typedef NS_ENUM(SInt32, ContactType) {
  ContactTypeContactUser = 1,
  ContactTypeContactGroup = 2,
};

BOOL ContactTypeIsValidValue(ContactType value);
NSString *NSStringFromContactType(ContactType value);

typedef NS_ENUM(SInt32, ContactModifyOpt) {
  ContactModifyOptAdd = 0,
  ContactModifyOptDel = 1,
};

BOOL ContactModifyOptIsValidValue(ContactModifyOpt value);
NSString *NSStringFromContactModifyOpt(ContactModifyOpt value);

typedef NS_ENUM(SInt32, SubscribeOpt) {
  SubscribeOptSubscribe = 0,
  SubscribeOptCancelsubscribe = 1,
};

BOOL SubscribeOptIsValidValue(SubscribeOpt value);
NSString *NSStringFromSubscribeOpt(SubscribeOpt value);

typedef NS_ENUM(SInt32, SubscribeRetCode) {
  SubscribeRetCodeSubscribeRetOk = 0,
  SubscribeRetCodeSubscribeRetFaild = 1,
};

BOOL SubscribeRetCodeIsValidValue(SubscribeRetCode value);
NSString *NSStringFromSubscribeRetCode(SubscribeRetCode value);

typedef NS_ENUM(SInt32, ContactModifyRetCode) {
  ContactModifyRetCodeOk = 0,
  ContactModifyRetCodeDbFaild = 3,
  ContactModifyRetCodeNovaliduser = 4,
  ContactModifyRetCodeNeetverify = 2,
  ContactModifyRetCodeNotvalidgroup = 16,
  ContactModifyRetCodeNotingroup = 17,
};
...
#define UserInfo_latest_update_time @"latestUpdateTime"
...
#define UserUpdateInfo_user_id @"userId"
#define UserUpdateInfo_latest_update_time @"latestUpdateTime"
@interface UserUpdateInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasUserId_:1;
  BOOL hasLatestUpdateTime_:1;
  UInt64 userId;
...
@interface UserUpdateInfoBuilder : PBGeneratedMessageBuilder {
@private
  UserUpdateInfo* resultUserUpdateInfo;
}
...
#define ContactInfo_id @"id"
#define ContactInfo_type @"type"
#define ContactInfo_status @"status"
#define ContactInfo_latest_update_time @"latestUpdateTime"
#define ContactInfo_rmkname @"rmkname"
@interface ContactInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasId_:1;
  BOOL hasRmkname_:1;
  BOOL hasType_:1;
...
@property (readonly) UInt32 status;
@property (readonly) UInt32 latestUpdateTime;
@property (readonly, strong) NSString* rmkname;
...
@interface ContactInfoBuilder : PBGeneratedMessageBuilder {
@private
...
#define SubscribeAttentionInfo_sb_uuid @"sbUuid"
#define SubscribeAttentionInfo_sb_differno @"sbDifferno"
#define SubscribeAttentionInfo_sb_id @"sbId"
@interface SubscribeAttentionInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasSbId_:1;
  BOOL hasSbUuid_:1;
...
@interface SubscribeAttentionInfoBuilder : PBGeneratedMessageBuilder {
@private
  SubscribeAttentionInfo* resultSubscribeAttentionInfo;
}
...
#define SubscribeInfo_sb_id @"sbId"
#define SubscribeInfo_sb_uuid @"sbUuid"
#define SubscribeInfo_sb_name @"sbName"
#define SubscribeInfo_sb_introduce @"sbIntroduce"
#define SubscribeInfo_sb_avatar @"sbAvatar"
#define SubscribeInfo_sb_fkbh @"sbFkbh"
#define SubscribeInfo_sb_subject @"sbSubject"
@interface SubscribeInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasSbId_:1;
  BOOL hasSbUuid_:1;
  BOOL hasSbName_:1;
  BOOL hasSbIntroduce_:1;
  BOOL hasSbAvatar_:1;
  BOOL hasSbFkbh_:1;
  BOOL hasSbSubject_:1;
  UInt64 sbId;
  NSString* sbUuid;
  NSString* sbName;
...
@property (readonly) UInt64 sbId;
@property (readonly, strong) NSString* sbUuid;
@property (readonly, strong) NSString* sbName;
@property (readonly, strong) NSString* sbIntroduce;
@property (readonly, strong) NSString* sbAvatar;
@property (readonly, strong) NSString* sbFkbh;
@property (readonly, strong) NSString* sbSubject;
...
@interface SubscribeInfoBuilder : PBGeneratedMessageBuilder {
@private
  SubscribeInfo* resultSubscribeInfo;
}
...
#define UnreadInfo_latest_msg_time @"latestMsgTime"
...
@property (readonly, strong) NSData* latestMsgData;
@property (readonly) MsgType latestMsgType;
@property (readonly) UInt64 latestMsgFromUserId;
@property (readonly) UInt32 latestMsgTime;
...
@property (readonly) UInt64 fromSessionId;
...
#define GroupUserInfo_user_id @"userId"
#define GroupUserInfo_group_nick @"groupNick"
@interface GroupUserInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasUserId_:1;
  BOOL hasGroupNick_:1;
  UInt64 userId;
  NSString* groupNick;
}
- (BOOL) hasUserId;
- (BOOL) hasGroupNick;
@property (readonly) UInt64 userId;
@property (readonly, strong) NSString* groupNick;
...
@interface GroupUserInfoBuilder : PBGeneratedMessageBuilder {
@private
  GroupUserInfo* resultGroupUserInfo;
}
...
#define GroupNickSerialInfo_user_id @"userId"
#define GroupNickSerialInfo_group_nick @"groupNick"
@interface GroupNickSerialInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasUserId_:1;
  BOOL hasGroupNick_:1;
  NSString* userId;
...
@interface GroupNickSerialInfoBuilder : PBGeneratedMessageBuilder {
@private
  GroupNickSerialInfo* resultGroupNickSerialInfo;
}
...
#define GroupInfo_group_nick_list @"groupNickList"
...
@private
  ...
  NSMutableArray * groupNickListArray;
}
- (BOOL) hasGroupId;
- (BOOL) hasVersion;
- (BOOL) hasGroupName;
...
@property (readonly) UInt64 groupCreatorId;
...
@property (readonly, strong) NSArray * groupNickList;
...
#define VerifyInfo_from_user_id @"fromUserId"
#define VerifyInfo_verify @"verify"
@interface VerifyInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasFromUserId_:1;
  BOOL hasVerify_:1;
  UInt64 fromUserId;
...
@interface VerifyInfoBuilder : PBGeneratedMessageBuilder {
@private
  VerifyInfo* resultVerifyInfo;
}
...
#define SubsribeMsgIdInfo_user_id @"userId"
#define SubsribeMsgIdInfo_msg_id @"msgId"
@interface SubsribeMsgIdInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasUserId_:1;
  BOOL hasMsgId_:1;
  UInt64 userId;
...
@interface SubsribeMsgIdInfoBuilder : PBGeneratedMessageBuilder {
@private
  SubsribeMsgIdInfo* resultSubsribeMsgIdInfo;
}
