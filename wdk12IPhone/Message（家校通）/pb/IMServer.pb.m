...
- (UInt64)userIdAtIndex:(NSUInteger)index {
  return [userIdArray uint64AtIndex:index];
}
- (BOOL) isInitialized {
  return YES;
}
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (userIdArrayCount > 0) {
    const UInt64 *values = (const UInt64 *)self.userIdArray.data;
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  for(int i=0;i<userIdArrayCount;i++){
    [userIdArrayArray addObject: @([self.userIdArray uint64AtIndex:i])];
  }
...
- (IMGetDeviceTokenReqBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 8: {
        [self addUserId:[input readUInt64]];
        break;
      }
      case 162: {
        [self setAttachData:[input readData]];
...
- (IMGetDeviceTokenReqBuilder *)addUserId:(UInt64)value {
  if (resultImgetDeviceTokenReq.userIdArray == nil) {
    resultImgetDeviceTokenReq.userIdArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeUInt64];
  }
  [resultImgetDeviceTokenReq.userIdArray addUint64:value];
  return self;
}
- (IMGetDeviceTokenReqBuilder *)setUserIdArray:(NSArray *)array {
  resultImgetDeviceTokenReq.userIdArray = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeUInt64];
  return self;
}
- (IMGetDeviceTokenReqBuilder *)setUserIdValues:(const UInt64 *)values count:(NSUInteger)count {
  resultImgetDeviceTokenReq.userIdArray = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeUInt64];
  return self;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasUserId) {
    [output writeUInt64:2 value:self.userId];
  }
  if (self.hasClientType) {
...
- (SInt32) serializedSize {
  ...
  if (self.hasUserId) {
    size_ += computeUInt64Size(2, self.userId);
  }
  if (self.hasClientType) {
...
- (IMUserStatusUpdateBuilder*) clearUserId {
  ...
  resultImuserStatusUpdate.userId = 0L;
  return self;
}
- (BOOL) hasClientType {
...
- (IMUserCntUpdateBuilder*) clearUserId {
  ...
  resultImuserCntUpdate.userId = 0L;
  return self;
}
@end
...
- (IMServerKickUserBuilder*) clearUserId {
  ...
  resultImserverKickUser.userId = 0L;
  return self;
}
- (BOOL) hasClientType {
...
- (IMServerPCLoginStatusNotifyBuilder*) clearUserId {
  ...
  resultImserverPcloginStatusNotify.userId = 0L;
  return self;
}
- (BOOL) hasLoginStatus {
...
- (IMGroupGetShieldReqBuilder*) clearGroupId {
  ...
  resultImgroupGetShieldReq.groupId = 0L;
  return self;
}
- (PBAppendableArray *)userId {
...
- (IMGroupGetShieldReqBuilder *)addUserId:(UInt64)value {
  if (resultImgroupGetShieldReq.userIdArray == nil) {
    resultImgroupGetShieldReq.userIdArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeUInt64];
  }
  [resultImgroupGetShieldReq.userIdArray addUint64:value];
  return self;
}
- (IMGroupGetShieldReqBuilder *)setUserIdArray:(NSArray *)array {
  resultImgroupGetShieldReq.userIdArray = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeUInt64];
  return self;
}
- (IMGroupGetShieldReqBuilder *)setUserIdValues:(const UInt64 *)values count:(NSUInteger)count {
  resultImgroupGetShieldReq.userIdArray = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeUInt64];
  return self;
}
...
- (IMGroupGetShieldRspBuilder*) clearGroupId {
  ...
  resultImgroupGetShieldRsp.groupId = 0L;
  return self;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasToUserId) {
    [output writeUInt64:2 value:self.toUserId];
  }
  if (self.hasFileName) {
...
- (SInt32) serializedSize {
  ...
  if (self.hasToUserId) {
    size_ += computeUInt64Size(2, self.toUserId);
  }
  if (self.hasFileName) {
...
- (IMFileTransferReqBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 16: {
        [self setToUserId:[input readUInt64]];
        break;
      }
      case 26: {
...
- (IMFileTransferReqBuilder*) clearFromUserId {
  ...
  resultImfileTransferReq.fromUserId = 0L;
  return self;
}
- (BOOL) hasToUserId {
...
- (IMFileTransferReqBuilder*) clearToUserId {
  ...
  resultImfileTransferReq.toUserId = 0L;
  return self;
}
- (BOOL) hasFileName {
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasFromUserId) {
    [output writeUInt64:2 value:self.fromUserId];
  }
  if (self.hasToUserId) {
    [output writeUInt64:3 value:self.toUserId];
  }
  if (self.hasFileName) {
...
- (SInt32) serializedSize {
  ...
  if (self.hasFromUserId) {
    size_ += computeUInt64Size(2, self.fromUserId);
  }
  if (self.hasToUserId) {
    size_ += computeUInt64Size(3, self.toUserId);
  }
  if (self.hasFileName) {
...
- (IMFileTransferRspBuilder*) clearFromUserId {
  ...
  resultImfileTransferRsp.fromUserId = 0L;
  return self;
}
- (BOOL) hasToUserId {
...
- (IMFileTransferRspBuilder*) clearToUserId {
  ...
  resultImfileTransferRsp.toUserId = 0L;
  return self;
}
- (BOOL) hasFileName {
...
@interface IMListContactInfoReq ()
@property (strong) NSString* loginId;
@property (strong) NSString* searchMc;
@property (strong) NSData* attachData;
@end

@implementation IMListContactInfoReq

- (BOOL) hasLoginId {
  return !!hasLoginId_;
}
- (void) setHasLoginId:(BOOL) _value_ {
  hasLoginId_ = !!_value_;
}
@synthesize loginId;
- (BOOL) hasSearchMc {
...
- (void) setHasSearchMc:(BOOL) _value_ {
  hasSearchMc_ = !!_value_;
}
@synthesize searchMc;
- (BOOL) hasAttachData {
  return !!hasAttachData_;
...
static IMListContactInfoReq* defaultIMListContactInfoReqInstance = nil;
+ (void) initialize {
  if (self == [IMListContactInfoReq class]) {
    defaultIMListContactInfoReqInstance = [[IMListContactInfoReq alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultIMListContactInfoReqInstance;
}
- (instancetype) defaultInstance {
  return defaultIMListContactInfoReqInstance;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasSearchMc) {
    [output writeString:2 value:self.searchMc];
  }
  if (self.hasAttachData) {
    [output writeData:20 value:self.attachData];
  }
...
- (SInt32) serializedSize {
  ...
  if (self.hasSearchMc) {
    size_ += computeStringSize(2, self.searchMc);
  }
  if (self.hasAttachData) {
    size_ += computeDataSize(20, self.attachData);
  }
...
+ (IMListContactInfoReq*) parseFromData:(NSData*) data {
  return (IMListContactInfoReq*)[[[IMListContactInfoReq builder] mergeFromData:data] build];
}
+ (IMListContactInfoReq*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMListContactInfoReq*)[[[IMListContactInfoReq builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (IMListContactInfoReq*) parseFromInputStream:(NSInputStream*) input {
  return (IMListContactInfoReq*)[[[IMListContactInfoReq builder] mergeFromInputStream:input] build];
}
+ (IMListContactInfoReq*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMListContactInfoReq*)[[[IMListContactInfoReq builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMListContactInfoReq*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (IMListContactInfoReq*)[[[IMListContactInfoReq builder] mergeFromCodedInputStream:input] build];
}
+ (IMListContactInfoReq*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMListContactInfoReq*)[[[IMListContactInfoReq builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMListContactInfoReqBuilder*) builder {
  return [[IMListContactInfoReqBuilder alloc] init];
}
+ (IMListContactInfoReqBuilder*) builderWithPrototype:(IMListContactInfoReq*) prototype {
  return [[IMListContactInfoReq builder] mergeFrom:prototype];
}
- (IMListContactInfoReqBuilder*) builder {
  return [IMListContactInfoReq builder];
}
- (IMListContactInfoReqBuilder*) toBuilder {
  return [IMListContactInfoReq builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasLoginId) {
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  if (self.hasLoginId) {
    [dictionary setObject: self.loginId forKey: @"loginId"];
  }
  if (self.hasSearchMc) {
    [dictionary setObject: self.searchMc forKey: @"searchMc"];
  }
  if (self.hasAttachData) {
    [dictionary setObject: self.attachData forKey: @"attachData"];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[IMListContactInfoReq class]]) {
    return NO;
  }
  IMListContactInfoReq *otherMessage = other;
  return
      self.hasLoginId == otherMessage.hasLoginId &&
      (!self.hasLoginId || [self.loginId isEqual:otherMessage.loginId]) &&
      self.hasSearchMc == otherMessage.hasSearchMc &&
      (!self.hasSearchMc || [self.searchMc isEqual:otherMessage.searchMc]) &&
      self.hasAttachData == otherMessage.hasAttachData &&
      (!self.hasAttachData || [self.attachData isEqual:otherMessage.attachData]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  __block NSUInteger hashCode = 7;
  if (self.hasLoginId) {
    hashCode = hashCode * 31 + [self.loginId hash];
  }
  if (self.hasSearchMc) {
    hashCode = hashCode * 31 + [self.searchMc hash];
  }
  if (self.hasAttachData) {
    hashCode = hashCode * 31 + [self.attachData hash];
  }
...
@interface IMListContactInfoReqBuilder()
@property (strong) IMListContactInfoReq* resultImlistContactInfoReq;
@end

@implementation IMListContactInfoReqBuilder
@synthesize resultImlistContactInfoReq;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultImlistContactInfoReq = [[IMListContactInfoReq alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultImlistContactInfoReq;
}
...
- (IMListContactInfoReqBuilder*) clone {
  return [IMListContactInfoReq builderWithPrototype:resultImlistContactInfoReq];
}
- (IMListContactInfoReq*) defaultInstance {
  return [IMListContactInfoReq defaultInstance];
}
...
- (IMListContactInfoReq*) buildPartial {
  IMListContactInfoReq* returnMe = resultImlistContactInfoReq;
  self.resultImlistContactInfoReq = nil;
  return returnMe;
}
- (IMListContactInfoReqBuilder*) mergeFrom:(IMListContactInfoReq*) other {
  if (other == [IMListContactInfoReq defaultInstance]) {
    return self;
  }
  if (other.hasLoginId) {
    [self setLoginId:other.loginId];
  }
  if (other.hasSearchMc) {
    [self setSearchMc:other.searchMc];
  }
  if (other.hasAttachData) {
    [self setAttachData:other.attachData];
  }
...
- (IMListContactInfoReqBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 18: {
        [self setSearchMc:[input readString]];
        break;
      }
      case 162: {
        [self setAttachData:[input readData]];
...
- (BOOL) hasLoginId {
  return resultImlistContactInfoReq.hasLoginId;
}
- (NSString*) loginId {
  return resultImlistContactInfoReq.loginId;
}
- (IMListContactInfoReqBuilder*) setLoginId:(NSString*) value {
  resultImlistContactInfoReq.hasLoginId = YES;
  resultImlistContactInfoReq.loginId = value;
  return self;
}
- (IMListContactInfoReqBuilder*) clearLoginId {
  resultImlistContactInfoReq.hasLoginId = NO;
  resultImlistContactInfoReq.loginId = @"";
  return self;
}
- (BOOL) hasSearchMc {
  return resultImlistContactInfoReq.hasSearchMc;
}
- (NSString*) searchMc {
  return resultImlistContactInfoReq.searchMc;
}
- (IMListContactInfoReqBuilder*) setSearchMc:(NSString*) value {
  resultImlistContactInfoReq.hasSearchMc = YES;
  resultImlistContactInfoReq.searchMc = value;
  return self;
}
- (IMListContactInfoReqBuilder*) clearSearchMc {
  resultImlistContactInfoReq.hasSearchMc = NO;
  resultImlistContactInfoReq.searchMc = @"";
  return self;
}
- (BOOL) hasAttachData {
  return resultImlistContactInfoReq.hasAttachData;
}
- (NSData*) attachData {
  return resultImlistContactInfoReq.attachData;
}
- (IMListContactInfoReqBuilder*) setAttachData:(NSData*) value {
  resultImlistContactInfoReq.hasAttachData = YES;
  resultImlistContactInfoReq.attachData = value;
  return self;
}
- (IMListContactInfoReqBuilder*) clearAttachData {
  resultImlistContactInfoReq.hasAttachData = NO;
  resultImlistContactInfoReq.attachData = [NSData data];
  return self;
}
@end

@interface GroupMemberHttpInfo ()
@property (strong) NSString* loginId;
@property (strong) NSString* name;
@end

@implementation GroupMemberHttpInfo
...
static GroupMemberHttpInfo* defaultGroupMemberHttpInfoInstance = nil;
+ (void) initialize {
  if (self == [GroupMemberHttpInfo class]) {
    defaultGroupMemberHttpInfoInstance = [[GroupMemberHttpInfo alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultGroupMemberHttpInfoInstance;
}
- (instancetype) defaultInstance {
  return defaultGroupMemberHttpInfoInstance;
}
...
+ (GroupMemberHttpInfo*) parseFromData:(NSData*) data {
  return (GroupMemberHttpInfo*)[[[GroupMemberHttpInfo builder] mergeFromData:data] build];
}
+ (GroupMemberHttpInfo*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (GroupMemberHttpInfo*)[[[GroupMemberHttpInfo builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (GroupMemberHttpInfo*) parseFromInputStream:(NSInputStream*) input {
  return (GroupMemberHttpInfo*)[[[GroupMemberHttpInfo builder] mergeFromInputStream:input] build];
}
+ (GroupMemberHttpInfo*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (GroupMemberHttpInfo*)[[[GroupMemberHttpInfo builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (GroupMemberHttpInfo*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (GroupMemberHttpInfo*)[[[GroupMemberHttpInfo builder] mergeFromCodedInputStream:input] build];
}
+ (GroupMemberHttpInfo*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (GroupMemberHttpInfo*)[[[GroupMemberHttpInfo builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (GroupMemberHttpInfoBuilder*) builder {
  return [[GroupMemberHttpInfoBuilder alloc] init];
}
+ (GroupMemberHttpInfoBuilder*) builderWithPrototype:(GroupMemberHttpInfo*) prototype {
  return [[GroupMemberHttpInfo builder] mergeFrom:prototype];
}
- (GroupMemberHttpInfoBuilder*) builder {
  return [GroupMemberHttpInfo builder];
}
- (GroupMemberHttpInfoBuilder*) toBuilder {
  return [GroupMemberHttpInfo builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasLoginId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"loginId", self.loginId];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[GroupMemberHttpInfo class]]) {
    return NO;
  }
  GroupMemberHttpInfo *otherMessage = other;
  return
      self.hasLoginId == otherMessage.hasLoginId &&
      (!self.hasLoginId || [self.loginId isEqual:otherMessage.loginId]) &&
...
@interface GroupMemberHttpInfoBuilder()
@property (strong) GroupMemberHttpInfo* resultGroupMemberHttpInfo;
@end

@implementation GroupMemberHttpInfoBuilder
@synthesize resultGroupMemberHttpInfo;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultGroupMemberHttpInfo = [[GroupMemberHttpInfo alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultGroupMemberHttpInfo;
}
...
- (GroupMemberHttpInfoBuilder*) clone {
  return [GroupMemberHttpInfo builderWithPrototype:resultGroupMemberHttpInfo];
}
- (GroupMemberHttpInfo*) defaultInstance {
  return [GroupMemberHttpInfo defaultInstance];
}
...
- (GroupMemberHttpInfo*) buildPartial {
  GroupMemberHttpInfo* returnMe = resultGroupMemberHttpInfo;
  self.resultGroupMemberHttpInfo = nil;
  return returnMe;
}
- (GroupMemberHttpInfoBuilder*) mergeFrom:(GroupMemberHttpInfo*) other {
  if (other == [GroupMemberHttpInfo defaultInstance]) {
    return self;
  }
  if (other.hasLoginId) {
    [self setLoginId:other.loginId];
...
- (BOOL) hasLoginId {
  return resultGroupMemberHttpInfo.hasLoginId;
}
- (NSString*) loginId {
  return resultGroupMemberHttpInfo.loginId;
}
- (GroupMemberHttpInfoBuilder*) setLoginId:(NSString*) value {
  resultGroupMemberHttpInfo.hasLoginId = YES;
  resultGroupMemberHttpInfo.loginId = value;
  return self;
}
- (GroupMemberHttpInfoBuilder*) clearLoginId {
  resultGroupMemberHttpInfo.hasLoginId = NO;
  resultGroupMemberHttpInfo.loginId = @"";
  return self;
}
- (BOOL) hasName {
  return resultGroupMemberHttpInfo.hasName;
}
- (NSString*) name {
  return resultGroupMemberHttpInfo.name;
}
- (GroupMemberHttpInfoBuilder*) setName:(NSString*) value {
  resultGroupMemberHttpInfo.hasName = YES;
  resultGroupMemberHttpInfo.name = value;
  return self;
}
- (GroupMemberHttpInfoBuilder*) clearName {
  resultGroupMemberHttpInfo.hasName = NO;
  resultGroupMemberHttpInfo.name = @"";
  return self;
}
@end

@interface GroupHttpInfo ()
@property UInt64 groupId;
@property (strong) NSString* groupName;
@property (strong) NSMutableArray * membersArray;
@end

@implementation GroupHttpInfo
...
static GroupHttpInfo* defaultGroupHttpInfoInstance = nil;
+ (void) initialize {
  if (self == [GroupHttpInfo class]) {
    defaultGroupHttpInfoInstance = [[GroupHttpInfo alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultGroupHttpInfoInstance;
}
- (instancetype) defaultInstance {
  return defaultGroupHttpInfoInstance;
}
...
- (BOOL) isInitialized {
  ...
  __block BOOL isInitmembers = YES;
   [self.members enumerateObjectsUsingBlock:^(GroupMemberHttpInfo *element, NSUInteger idx, BOOL *stop) {
    if (!element.isInitialized) {
      isInitmembers = NO;
      *stop = YES;
    }
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  [self.membersArray enumerateObjectsUsingBlock:^(GroupMemberHttpInfo *element, NSUInteger idx, BOOL *stop) {
    [output writeMessage:3 value:element];
  }];
  [self.unknownFields writeToCodedOutputStream:output];
}
...
+ (GroupHttpInfo*) parseFromData:(NSData*) data {
  return (GroupHttpInfo*)[[[GroupHttpInfo builder] mergeFromData:data] build];
}
+ (GroupHttpInfo*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (GroupHttpInfo*)[[[GroupHttpInfo builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (GroupHttpInfo*) parseFromInputStream:(NSInputStream*) input {
  return (GroupHttpInfo*)[[[GroupHttpInfo builder] mergeFromInputStream:input] build];
}
+ (GroupHttpInfo*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (GroupHttpInfo*)[[[GroupHttpInfo builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (GroupHttpInfo*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (GroupHttpInfo*)[[[GroupHttpInfo builder] mergeFromCodedInputStream:input] build];
}
+ (GroupHttpInfo*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (GroupHttpInfo*)[[[GroupHttpInfo builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (GroupHttpInfoBuilder*) builder {
  return [[GroupHttpInfoBuilder alloc] init];
}
+ (GroupHttpInfoBuilder*) builderWithPrototype:(GroupHttpInfo*) prototype {
  return [[GroupHttpInfo builder] mergeFrom:prototype];
}
- (GroupHttpInfoBuilder*) builder {
  return [GroupHttpInfo builder];
}
- (GroupHttpInfoBuilder*) toBuilder {
  return [GroupHttpInfo builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasGroupId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"groupId", [NSNumber numberWithLongLong:self.groupId]];
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  for (GroupMemberHttpInfo* element in self.membersArray) {
    NSMutableDictionary *elementDictionary = [NSMutableDictionary dictionary];
    [element storeInDictionary:elementDictionary];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[GroupHttpInfo class]]) {
    return NO;
  }
  GroupHttpInfo *otherMessage = other;
  return
      self.hasGroupId == otherMessage.hasGroupId &&
      (!self.hasGroupId || self.groupId == otherMessage.groupId) &&
...
@interface GroupHttpInfoBuilder()
@property (strong) GroupHttpInfo* resultGroupHttpInfo;
@end

@implementation GroupHttpInfoBuilder
@synthesize resultGroupHttpInfo;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultGroupHttpInfo = [[GroupHttpInfo alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultGroupHttpInfo;
}
...
- (GroupHttpInfoBuilder*) clone {
  return [GroupHttpInfo builderWithPrototype:resultGroupHttpInfo];
}
- (GroupHttpInfo*) defaultInstance {
  return [GroupHttpInfo defaultInstance];
}
- (GroupHttpInfo*) build {
  [self checkInitialized];
  return [self buildPartial];
...
- (GroupHttpInfo*) buildPartial {
  GroupHttpInfo* returnMe = resultGroupHttpInfo;
  self.resultGroupHttpInfo = nil;
  return returnMe;
}
- (GroupHttpInfoBuilder*) mergeFrom:(GroupHttpInfo*) other {
  if (other == [GroupHttpInfo defaultInstance]) {
    return self;
  }
  if (other.hasGroupId) {
    [self setGroupId:other.groupId];
  ...
  if (other.membersArray.count > 0) {
    if (resultGroupHttpInfo.membersArray == nil) {
      resultGroupHttpInfo.membersArray = [[NSMutableArray alloc] initWithArray:other.membersArray];
    } else {
      [resultGroupHttpInfo.membersArray addObjectsFromArray:other.membersArray];
    }
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
...
- (GroupHttpInfoBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 26: {
        GroupMemberHttpInfoBuilder* subBuilder = [GroupMemberHttpInfo builder];
        [input readMessage:subBuilder extensionRegistry:extensionRegistry];
...
- (BOOL) hasGroupId {
  return resultGroupHttpInfo.hasGroupId;
}
- (UInt64) groupId {
  return resultGroupHttpInfo.groupId;
}
- (GroupHttpInfoBuilder*) setGroupId:(UInt64) value {
  resultGroupHttpInfo.hasGroupId = YES;
  resultGroupHttpInfo.groupId = value;
  return self;
}
- (GroupHttpInfoBuilder*) clearGroupId {
  resultGroupHttpInfo.hasGroupId = NO;
  resultGroupHttpInfo.groupId = 0L;
  return self;
}
- (BOOL) hasGroupName {
  return resultGroupHttpInfo.hasGroupName;
}
- (NSString*) groupName {
  return resultGroupHttpInfo.groupName;
}
- (GroupHttpInfoBuilder*) setGroupName:(NSString*) value {
  resultGroupHttpInfo.hasGroupName = YES;
  resultGroupHttpInfo.groupName = value;
  return self;
}
- (GroupHttpInfoBuilder*) clearGroupName {
  resultGroupHttpInfo.hasGroupName = NO;
  resultGroupHttpInfo.groupName = @"";
  return self;
}
- (NSMutableArray *)members {
  return resultGroupHttpInfo.membersArray;
}
- (GroupMemberHttpInfo*)membersAtIndex:(NSUInteger)index {
  return [resultGroupHttpInfo membersAtIndex:index];
}
- (GroupHttpInfoBuilder *)addMembers:(GroupMemberHttpInfo*)value {
  if (resultGroupHttpInfo.membersArray == nil) {
    resultGroupHttpInfo.membersArray = [[NSMutableArray alloc]init];
  }
  [resultGroupHttpInfo.membersArray addObject:value];
  return self;
}
- (GroupHttpInfoBuilder *)setMembersArray:(NSArray *)array {
  resultGroupHttpInfo.membersArray = [[NSMutableArray alloc]initWithArray:array];
  return self;
}
- (GroupHttpInfoBuilder *)clearMembers {
  resultGroupHttpInfo.membersArray = nil;
  return self;
}
@end

@interface IMListContactInfoRsp ()
@property (strong) NSMutableArray * groupInfosArray;
@property (strong) NSString* searchMc;
@property (strong) NSData* attachData;
@end

@implementation IMListContactInfoRsp

@synthesize groupInfosArray;
@dynamic groupInfos;
- (BOOL) hasSearchMc {
  return !!hasSearchMc_;
}
...
static IMListContactInfoRsp* defaultIMListContactInfoRspInstance = nil;
+ (void) initialize {
  if (self == [IMListContactInfoRsp class]) {
    defaultIMListContactInfoRspInstance = [[IMListContactInfoRsp alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultIMListContactInfoRspInstance;
}
- (instancetype) defaultInstance {
  return defaultIMListContactInfoRspInstance;
}
- (NSArray *)groupInfos {
  return groupInfosArray;
}
- (GroupHttpInfo*)groupInfosAtIndex:(NSUInteger)index {
  return [groupInfosArray objectAtIndex:index];
}
- (BOOL) isInitialized {
  if (!self.hasSearchMc) {
    return NO;
  }
  __block BOOL isInitgroupInfos = YES;
   [self.groupInfos enumerateObjectsUsingBlock:^(GroupHttpInfo *element, NSUInteger idx, BOOL *stop) {
    if (!element.isInitialized) {
      isInitgroupInfos = NO;
      *stop = YES;
    }
  }];
  if (!isInitgroupInfos) return isInitgroupInfos;
  return YES;
}
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  [self.groupInfosArray enumerateObjectsUsingBlock:^(GroupHttpInfo *element, NSUInteger idx, BOOL *stop) {
    [output writeMessage:1 value:element];
  }];
  if (self.hasSearchMc) {
    [output writeString:2 value:self.searchMc];
...
+ (IMListContactInfoRsp*) parseFromData:(NSData*) data {
  return (IMListContactInfoRsp*)[[[IMListContactInfoRsp builder] mergeFromData:data] build];
}
+ (IMListContactInfoRsp*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMListContactInfoRsp*)[[[IMListContactInfoRsp builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (IMListContactInfoRsp*) parseFromInputStream:(NSInputStream*) input {
  return (IMListContactInfoRsp*)[[[IMListContactInfoRsp builder] mergeFromInputStream:input] build];
}
+ (IMListContactInfoRsp*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMListContactInfoRsp*)[[[IMListContactInfoRsp builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMListContactInfoRsp*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (IMListContactInfoRsp*)[[[IMListContactInfoRsp builder] mergeFromCodedInputStream:input] build];
}
+ (IMListContactInfoRsp*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMListContactInfoRsp*)[[[IMListContactInfoRsp builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMListContactInfoRspBuilder*) builder {
  return [[IMListContactInfoRspBuilder alloc] init];
}
+ (IMListContactInfoRspBuilder*) builderWithPrototype:(IMListContactInfoRsp*) prototype {
  return [[IMListContactInfoRsp builder] mergeFrom:prototype];
}
- (IMListContactInfoRspBuilder*) builder {
  return [IMListContactInfoRsp builder];
}
- (IMListContactInfoRspBuilder*) toBuilder {
  return [IMListContactInfoRsp builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  [self.groupInfosArray enumerateObjectsUsingBlock:^(GroupHttpInfo *element, NSUInteger idx, BOOL *stop) {
    [output appendFormat:@"%@%@ {\n", indent, @"groupInfos"];
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  for (GroupHttpInfo* element in self.groupInfosArray) {
    NSMutableDictionary *elementDictionary = [NSMutableDictionary dictionary];
    [element storeInDictionary:elementDictionary];
    [dictionary setObject:[NSDictionary dictionaryWithDictionary:elementDictionary] forKey:@"groupInfos"];
  }
  if (self.hasSearchMc) {
    [dictionary setObject: self.searchMc forKey: @"searchMc"];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[IMListContactInfoRsp class]]) {
    return NO;
  }
  IMListContactInfoRsp *otherMessage = other;
  return
      [self.groupInfosArray isEqualToArray:otherMessage.groupInfosArray] &&
      self.hasSearchMc == otherMessage.hasSearchMc &&
      (!self.hasSearchMc || [self.searchMc isEqual:otherMessage.searchMc]) &&
      self.hasAttachData == otherMessage.hasAttachData &&
      (!self.hasAttachData || [self.attachData isEqual:otherMessage.attachData]) &&
...
@interface IMListContactInfoRspBuilder()
@property (strong) IMListContactInfoRsp* resultImlistContactInfoRsp;
@end

@implementation IMListContactInfoRspBuilder
@synthesize resultImlistContactInfoRsp;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultImlistContactInfoRsp = [[IMListContactInfoRsp alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultImlistContactInfoRsp;
}
...
- (IMListContactInfoRspBuilder*) clone {
  return [IMListContactInfoRsp builderWithPrototype:resultImlistContactInfoRsp];
}
- (IMListContactInfoRsp*) defaultInstance {
  return [IMListContactInfoRsp defaultInstance];
}
...
- (IMListContactInfoRsp*) buildPartial {
  IMListContactInfoRsp* returnMe = resultImlistContactInfoRsp;
  self.resultImlistContactInfoRsp = nil;
  return returnMe;
}
- (IMListContactInfoRspBuilder*) mergeFrom:(IMListContactInfoRsp*) other {
  if (other == [IMListContactInfoRsp defaultInstance]) {
    return self;
  }
  if (other.groupInfosArray.count > 0) {
    if (resultImlistContactInfoRsp.groupInfosArray == nil) {
      resultImlistContactInfoRsp.groupInfosArray = [[NSMutableArray alloc] initWithArray:other.groupInfosArray];
    } else {
      [resultImlistContactInfoRsp.groupInfosArray addObjectsFromArray:other.groupInfosArray];
    }
  }
  if (other.hasSearchMc) {
    [self setSearchMc:other.searchMc];
...
- (IMListContactInfoRspBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 10: {
        GroupHttpInfoBuilder* subBuilder = [GroupHttpInfo builder];
        [input readMessage:subBuilder extensionRegistry:extensionRegistry];
        [self addGroupInfos:[subBuilder buildPartial]];
        break;
      }
      case 18: {
        [self setSearchMc:[input readString]];
...
- (NSMutableArray *)groupInfos {
  return resultImlistContactInfoRsp.groupInfosArray;
}
- (GroupHttpInfo*)groupInfosAtIndex:(NSUInteger)index {
  return [resultImlistContactInfoRsp groupInfosAtIndex:index];
}
- (IMListContactInfoRspBuilder *)addGroupInfos:(GroupHttpInfo*)value {
  if (resultImlistContactInfoRsp.groupInfosArray == nil) {
    resultImlistContactInfoRsp.groupInfosArray = [[NSMutableArray alloc]init];
  }
  [resultImlistContactInfoRsp.groupInfosArray addObject:value];
  return self;
}
- (IMListContactInfoRspBuilder *)setGroupInfosArray:(NSArray *)array {
  resultImlistContactInfoRsp.groupInfosArray = [[NSMutableArray alloc]initWithArray:array];
  return self;
}
- (IMListContactInfoRspBuilder *)clearGroupInfos {
  resultImlistContactInfoRsp.groupInfosArray = nil;
  return self;
}
- (BOOL) hasSearchMc {
  return resultImlistContactInfoRsp.hasSearchMc;
}
- (NSString*) searchMc {
  return resultImlistContactInfoRsp.searchMc;
}
- (IMListContactInfoRspBuilder*) setSearchMc:(NSString*) value {
  resultImlistContactInfoRsp.hasSearchMc = YES;
  resultImlistContactInfoRsp.searchMc = value;
  return self;
}
- (IMListContactInfoRspBuilder*) clearSearchMc {
  resultImlistContactInfoRsp.hasSearchMc = NO;
  resultImlistContactInfoRsp.searchMc = @"";
  return self;
}
- (BOOL) hasAttachData {
  return resultImlistContactInfoRsp.hasAttachData;
}
- (NSData*) attachData {
  return resultImlistContactInfoRsp.attachData;
}
- (IMListContactInfoRspBuilder*) setAttachData:(NSData*) value {
  resultImlistContactInfoRsp.hasAttachData = YES;
  resultImlistContactInfoRsp.attachData = value;
  return self;
}
- (IMListContactInfoRspBuilder*) clearAttachData {
  resultImlistContactInfoRsp.hasAttachData = NO;
  resultImlistContactInfoRsp.attachData = [NSData data];
  return self;
}
@end
