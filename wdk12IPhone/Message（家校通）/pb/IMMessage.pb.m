...
- (BOOL) hasSenderLastetUpdated {
  return !!hasSenderLastetUpdated_;
}
- (void) setHasSenderLastetUpdated:(BOOL) _value_ {
  hasSenderLastetUpdated_ = !!_value_;
}
@synthesize senderLastetUpdated;
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasToSessionId) {
    [output writeUInt64:2 value:self.toSessionId];
  }
  if (self.hasMsgId) {
  ...
  if (self.hasSenderLastetUpdated) {
    [output writeUInt32:18 value:self.senderLastetUpdated];
  }
  ...
  if (curUserIdListArrayCount > 0) {
    ...
    for (NSUInteger i = 0; i < curUserIdListArrayCount; ++i) {
      [output writeUInt64:19 value:values[i]];
    }
  }
...
- (SInt32) serializedSize {
  ...
  if (self.hasToSessionId) {
    size_ += computeUInt64Size(2, self.toSessionId);
  }
  if (self.hasMsgId) {
  ...
  if (self.hasSenderLastetUpdated) {
    size_ += computeUInt32Size(18, self.senderLastetUpdated);
  }
  {
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasToSessionId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"toSessionId", [NSNumber numberWithLongLong:self.toSessionId]];
  }
  if (self.hasMsgId) {
  ...
  if (self.hasSenderLastetUpdated) {
    [output appendFormat:@"%@%@: %@\n", indent, @"senderLastetUpdated", [NSNumber numberWithInteger:self.senderLastetUpdated]];
  }
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  if (self.hasToSessionId) {
    [dictionary setObject: [NSNumber numberWithLongLong:self.toSessionId] forKey: @"toSessionId"];
  }
  if (self.hasMsgId) {
  ...
  if (self.hasSenderLastetUpdated) {
    [dictionary setObject: [NSNumber numberWithInteger:self.senderLastetUpdated] forKey: @"senderLastetUpdated"];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      self.hasSenderLastetUpdated == otherMessage.hasSenderLastetUpdated &&
      (!self.hasSenderLastetUpdated || self.senderLastetUpdated == otherMessage.senderLastetUpdated) &&
...
- (NSUInteger) hash {
  ...
  if (self.hasToSessionId) {
    hashCode = hashCode * 31 + [[NSNumber numberWithLongLong:self.toSessionId] hash];
  }
  if (self.hasMsgId) {
  ...
  if (self.hasSenderLastetUpdated) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInteger:self.senderLastetUpdated] hash];
  }
...
- (IMMsgDataBuilder*) mergeFrom:(IMMsgData*) other {
  ...
  if (other.hasSenderLastetUpdated) {
    [self setSenderLastetUpdated:other.senderLastetUpdated];
  }
  if (other.curUserIdListArray.count > 0) {
    if (resultImmsgData.curUserIdListArray == nil) {
      resultImmsgData.curUserIdListArray = [other.curUserIdListArray copy];
    } else {
      [resultImmsgData.curUserIdListArray appendArray:other.curUserIdListArray];
    }
  }
...
- (IMMsgDataBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 16: {
        [self setToSessionId:[input readUInt64]];
        break;
      }
      case 24: {
      ...
      case 144: {
        [self setSenderLastetUpdated:[input readUInt32]];
        break;
      }
      case 152: {
...
- (IMMsgDataBuilder*) clearToSessionId {
  ...
  resultImmsgData.toSessionId = 0L;
  return self;
}
- (BOOL) hasMsgId {
...
- (BOOL) hasSenderLastetUpdated {
  return resultImmsgData.hasSenderLastetUpdated;
}
- (UInt32) senderLastetUpdated {
  return resultImmsgData.senderLastetUpdated;
}
- (IMMsgDataBuilder*) setSenderLastetUpdated:(UInt32) value {
  resultImmsgData.hasSenderLastetUpdated = YES;
  resultImmsgData.senderLastetUpdated = value;
  return self;
}
- (IMMsgDataBuilder*) clearSenderLastetUpdated {
  resultImmsgData.hasSenderLastetUpdated = NO;
  resultImmsgData.senderLastetUpdated = 0;
  return self;
}
- (PBAppendableArray *)curUserIdList {
  return resultImmsgData.curUserIdListArray;
}
- (UInt64)curUserIdListAtIndex:(NSUInteger)index {
  return [resultImmsgData curUserIdListAtIndex:index];
}
- (IMMsgDataBuilder *)addCurUserIdList:(UInt64)value {
  if (resultImmsgData.curUserIdListArray == nil) {
    resultImmsgData.curUserIdListArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeUInt64];
  }
  [resultImmsgData.curUserIdListArray addUint64:value];
  return self;
}
- (IMMsgDataBuilder *)setCurUserIdListArray:(NSArray *)array {
  resultImmsgData.curUserIdListArray = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeUInt64];
  return self;
}
- (IMMsgDataBuilder *)setCurUserIdListValues:(const UInt64 *)values count:(NSUInteger)count {
  resultImmsgData.curUserIdListArray = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeUInt64];
  return self;
}
- (IMMsgDataBuilder *)clearCurUserIdList {
  resultImmsgData.curUserIdListArray = nil;
  return self;
}
- (BOOL) hasAttachData {
...
- (IMMsgDataAckBuilder*) clearSessionId {
  ...
  resultImmsgDataAck.sessionId = 0L;
  return self;
}
- (BOOL) hasMsgId {
...
- (IMMsgDataReadAckBuilder*) clearUserId {
  ...
  resultImmsgDataReadAck.userId = 0L;
  return self;
}
- (BOOL) hasSessionId {
...
- (IMMsgDataReadAckBuilder*) clearSessionId {
  ...
  resultImmsgDataReadAck.sessionId = 0L;
  return self;
}
- (BOOL) hasMsgId {
...
- (IMMsgDataReadAckBuilder*) clearMsgId {
  ...
  resultImmsgDataReadAck.msgId = 0L;
  return self;
}
- (BOOL) hasSessionType {
...
- (IMMsgDataReadNotifyBuilder*) clearUserId {
  ...
  resultImmsgDataReadNotify.userId = 0L;
  return self;
}
- (BOOL) hasSessionId {
...
- (IMMsgDataReadNotifyBuilder*) clearSessionId {
  ...
  resultImmsgDataReadNotify.sessionId = 0L;
  return self;
}
- (BOOL) hasMsgId {
...
- (IMMsgDataReadNotifyBuilder*) clearMsgId {
  ...
  resultImmsgDataReadNotify.msgId = 0L;
  return self;
}
- (BOOL) hasSessionType {
...
- (IMUnreadMsgCntReqBuilder*) clearUserId {
  ...
  resultImunreadMsgCntReq.userId = 0L;
  return self;
}
- (BOOL) hasAttachData {
...
- (IMUnreadMsgCntRspBuilder*) clearUserId {
  ...
  resultImunreadMsgCntRsp.userId = 0L;
  return self;
}
- (BOOL) hasTotalCnt {
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasMsgIdBegin) {
    [output writeUInt64:4 value:self.msgIdBegin];
  }
  if (self.hasMsgCnt) {
...
- (SInt32) serializedSize {
  ...
  if (self.hasMsgIdBegin) {
    size_ += computeUInt64Size(4, self.msgIdBegin);
  }
  if (self.hasMsgCnt) {
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasMsgIdBegin) {
    [output appendFormat:@"%@%@: %@\n", indent, @"msgIdBegin", [NSNumber numberWithLongLong:self.msgIdBegin]];
  }
  if (self.hasMsgCnt) {
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  if (self.hasMsgIdBegin) {
    [dictionary setObject: [NSNumber numberWithLongLong:self.msgIdBegin] forKey: @"msgIdBegin"];
  }
  if (self.hasMsgCnt) {
...
- (NSUInteger) hash {
  ...
  if (self.hasMsgIdBegin) {
    hashCode = hashCode * 31 + [[NSNumber numberWithLongLong:self.msgIdBegin] hash];
  }
  if (self.hasMsgCnt) {
...
- (IMGetMsgListReqBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 32: {
        [self setMsgIdBegin:[input readUInt64]];
        break;
      }
      case 40: {
...
- (IMGetMsgListReqBuilder*) clearUserId {
  ...
  resultImgetMsgListReq.userId = 0L;
  return self;
}
- (BOOL) hasSessionType {
...
- (IMGetMsgListReqBuilder*) clearSessionId {
  ...
  resultImgetMsgListReq.sessionId = 0L;
  return self;
}
- (BOOL) hasMsgIdBegin {
...
- (IMGetMsgListReqBuilder*) clearMsgIdBegin {
  ...
  resultImgetMsgListReq.msgIdBegin = 0L;
  return self;
}
- (BOOL) hasMsgCnt {
...
- (IMGetMsgListRspBuilder*) clearUserId {
  ...
  resultImgetMsgListRsp.userId = 0L;
  return self;
}
- (BOOL) hasSessionType {
...
- (IMGetMsgListRspBuilder*) clearSessionId {
  ...
  resultImgetMsgListRsp.sessionId = 0L;
  return self;
}
- (BOOL) hasMsgIdBegin {
...
- (IMGetMsgListRspBuilder*) clearMsgIdBegin {
  ...
  resultImgetMsgListRsp.msgIdBegin = 0L;
  return self;
}
...
- (IMGetLatestMsgIdReqBuilder*) clearUserId {
  ...
  resultImgetLatestMsgIdReq.userId = 0L;
  return self;
}
- (BOOL) hasSessionType {
...
- (IMGetLatestMsgIdReqBuilder*) clearSessionId {
  ...
  resultImgetLatestMsgIdReq.sessionId = 0L;
  return self;
}
- (BOOL) hasAttachData {
...
- (IMGetLatestMsgIdRspBuilder*) clearUserId {
  ...
  resultImgetLatestMsgIdRsp.userId = 0L;
  return self;
}
- (BOOL) hasSessionType {
...
- (IMGetLatestMsgIdRspBuilder*) clearSessionId {
  ...
  resultImgetLatestMsgIdRsp.sessionId = 0L;
  return self;
}
- (BOOL) hasLatestMsgId {
...
- (IMGetLatestMsgIdRspBuilder*) clearLatestMsgId {
  ...
  resultImgetLatestMsgIdRsp.latestMsgId = 0L;
  return self;
}
- (BOOL) hasAttachData {
...
- (UInt64)msgIdListAtIndex:(NSUInteger)index {
  return [msgIdListArray uint64AtIndex:index];
}
- (BOOL) isInitialized {
  if (!self.hasUserId) {
    return NO;
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (msgIdListArrayCount > 0) {
    const UInt64 *values = (const UInt64 *)self.msgIdListArray.data;
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  for(int i=0;i<msgIdListArrayCount;i++){
    [msgIdListArrayArray addObject: @([self.msgIdListArray uint64AtIndex:i])];
  }
...
- (IMGetMsgByIdReqBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 32: {
        [self addMsgIdList:[input readUInt64]];
        break;
      }
      case 162: {
        [self setAttachData:[input readData]];
...
- (IMGetMsgByIdReqBuilder*) clearUserId {
  ...
  resultImgetMsgByIdReq.userId = 0L;
  return self;
}
- (BOOL) hasSessionType {
...
- (IMGetMsgByIdReqBuilder*) clearSessionId {
  ...
  resultImgetMsgByIdReq.sessionId = 0L;
  return self;
}
...
- (IMGetMsgByIdReqBuilder *)addMsgIdList:(UInt64)value {
  if (resultImgetMsgByIdReq.msgIdListArray == nil) {
    resultImgetMsgByIdReq.msgIdListArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeUInt64];
  }
  [resultImgetMsgByIdReq.msgIdListArray addUint64:value];
  return self;
}
- (IMGetMsgByIdReqBuilder *)setMsgIdListArray:(NSArray *)array {
  resultImgetMsgByIdReq.msgIdListArray = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeUInt64];
  return self;
}
- (IMGetMsgByIdReqBuilder *)setMsgIdListValues:(const UInt64 *)values count:(NSUInteger)count {
  resultImgetMsgByIdReq.msgIdListArray = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeUInt64];
  return self;
}
...
- (IMGetMsgByIdRspBuilder*) clearUserId {
  ...
  resultImgetMsgByIdRsp.userId = 0L;
  return self;
}
- (BOOL) hasSessionType {
...
- (IMGetMsgByIdRspBuilder*) clearSessionId {
  ...
  resultImgetMsgByIdRsp.sessionId = 0L;
  return self;
}
- (NSMutableArray *)msgList {
...
@interface IMSubscribeHttpSendMessageRequest ()
@property (strong) NSString* sbUuid;
@property UInt64 sbId;
@property (strong) NSString* infoid;
@property (strong) PBAppendableArray * userListArray;
@property MsgType msgType;
@property (strong) NSData* msgData;
@property (strong) NSString* groupId;
@property UInt64 sbLoginid;
@property (strong) NSData* attachData;
@end

@implementation IMSubscribeHttpSendMessageRequest
...
- (void) setHasInfoid:(BOOL) _value_ {
  hasInfoid_ = !!_value_;
}
@synthesize infoid;
...
@synthesize groupId;
- (BOOL) hasSbLoginid {
  return !!hasSbLoginid_;
}
- (void) setHasSbLoginid:(BOOL) _value_ {
  hasSbLoginid_ = !!_value_;
}
@synthesize sbLoginid;
- (BOOL) hasAttachData {
  return !!hasAttachData_;
}
- (void) setHasAttachData:(BOOL) _value_ {
...
static IMSubscribeHttpSendMessageRequest* defaultIMSubscribeHttpSendMessageRequestInstance = nil;
+ (void) initialize {
  if (self == [IMSubscribeHttpSendMessageRequest class]) {
    defaultIMSubscribeHttpSendMessageRequestInstance = [[IMSubscribeHttpSendMessageRequest alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultIMSubscribeHttpSendMessageRequestInstance;
}
- (instancetype) defaultInstance {
  return defaultIMSubscribeHttpSendMessageRequestInstance;
}
...
- (UInt64)userListAtIndex:(NSUInteger)index {
  return [userListArray uint64AtIndex:index];
}
- (BOOL) isInitialized {
  if (!self.hasSbUuid) {
    return NO;
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasSbId) {
    [output writeUInt64:2 value:self.sbId];
  }
  if (self.hasInfoid) {
    [output writeString:3 value:self.infoid];
  }
  const NSUInteger userListArrayCount = self.userListArray.count;
  if (userListArrayCount > 0) {
    const UInt64 *values = (const UInt64 *)self.userListArray.data;
  ...
  if (self.hasSbLoginid) {
    [output writeUInt64:8 value:self.sbLoginid];
  }
  if (self.hasAttachData) {
    [output writeData:20 value:self.attachData];
  }
...
- (SInt32) serializedSize {
  ...
  if (self.hasSbId) {
    size_ += computeUInt64Size(2, self.sbId);
  }
  if (self.hasInfoid) {
    size_ += computeStringSize(3, self.infoid);
  }
  {
    __block SInt32 dataSize = 0;
  ...
  if (self.hasSbLoginid) {
    size_ += computeUInt64Size(8, self.sbLoginid);
  }
  if (self.hasAttachData) {
    size_ += computeDataSize(20, self.attachData);
  }
...
+ (IMSubscribeHttpSendMessageRequest*) parseFromData:(NSData*) data {
  return (IMSubscribeHttpSendMessageRequest*)[[[IMSubscribeHttpSendMessageRequest builder] mergeFromData:data] build];
}
+ (IMSubscribeHttpSendMessageRequest*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMSubscribeHttpSendMessageRequest*)[[[IMSubscribeHttpSendMessageRequest builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (IMSubscribeHttpSendMessageRequest*) parseFromInputStream:(NSInputStream*) input {
  return (IMSubscribeHttpSendMessageRequest*)[[[IMSubscribeHttpSendMessageRequest builder] mergeFromInputStream:input] build];
}
+ (IMSubscribeHttpSendMessageRequest*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMSubscribeHttpSendMessageRequest*)[[[IMSubscribeHttpSendMessageRequest builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMSubscribeHttpSendMessageRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (IMSubscribeHttpSendMessageRequest*)[[[IMSubscribeHttpSendMessageRequest builder] mergeFromCodedInputStream:input] build];
}
+ (IMSubscribeHttpSendMessageRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMSubscribeHttpSendMessageRequest*)[[[IMSubscribeHttpSendMessageRequest builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMSubscribeHttpSendMessageRequestBuilder*) builder {
  return [[IMSubscribeHttpSendMessageRequestBuilder alloc] init];
}
+ (IMSubscribeHttpSendMessageRequestBuilder*) builderWithPrototype:(IMSubscribeHttpSendMessageRequest*) prototype {
  return [[IMSubscribeHttpSendMessageRequest builder] mergeFrom:prototype];
}
- (IMSubscribeHttpSendMessageRequestBuilder*) builder {
  return [IMSubscribeHttpSendMessageRequest builder];
}
- (IMSubscribeHttpSendMessageRequestBuilder*) toBuilder {
  return [IMSubscribeHttpSendMessageRequest builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasSbUuid) {
  ...
  if (self.hasSbLoginid) {
    [output appendFormat:@"%@%@: %@\n", indent, @"sbLoginid", [NSNumber numberWithLongLong:self.sbLoginid]];
  }
  if (self.hasAttachData) {
    [output appendFormat:@"%@%@: %@\n", indent, @"attachData", self.attachData];
  }
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  if (self.hasInfoid) {
    [dictionary setObject: self.infoid forKey: @"infoid"];
  }
  NSMutableArray * userListArrayArray = [NSMutableArray new];
  NSUInteger userListArrayCount=self.userListArray.count;
  for(int i=0;i<userListArrayCount;i++){
    [userListArrayArray addObject: @([self.userListArray uint64AtIndex:i])];
  }
  [dictionary setObject: userListArrayArray forKey: @"userList"];
  if (self.hasMsgType) {
    [dictionary setObject: @(self.msgType) forKey: @"msgType"];
  }
  if (self.hasMsgData) {
  ...
  if (self.hasSbLoginid) {
    [dictionary setObject: [NSNumber numberWithLongLong:self.sbLoginid] forKey: @"sbLoginid"];
  }
  if (self.hasAttachData) {
    [dictionary setObject: self.attachData forKey: @"attachData"];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[IMSubscribeHttpSendMessageRequest class]]) {
    return NO;
  }
  IMSubscribeHttpSendMessageRequest *otherMessage = other;
  return
      ...
      self.hasInfoid == otherMessage.hasInfoid &&
      (!self.hasInfoid || [self.infoid isEqual:otherMessage.infoid]) &&
      ...
      self.hasSbLoginid == otherMessage.hasSbLoginid &&
      (!self.hasSbLoginid || self.sbLoginid == otherMessage.sbLoginid) &&
      self.hasAttachData == otherMessage.hasAttachData &&
      (!self.hasAttachData || [self.attachData isEqual:otherMessage.attachData]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  ...
  if (self.hasInfoid) {
    hashCode = hashCode * 31 + [self.infoid hash];
  }
  [self.userListArray enumerateObjectsUsingBlock:^(NSNumber *obj, NSUInteger idx, BOOL *stop) {
    hashCode = hashCode * 31 + [obj longValue];
  }];
  if (self.hasMsgType) {
    hashCode = hashCode * 31 + self.msgType;
  ...
  if (self.hasSbLoginid) {
    hashCode = hashCode * 31 + [[NSNumber numberWithLongLong:self.sbLoginid] hash];
  }
  if (self.hasAttachData) {
    hashCode = hashCode * 31 + [self.attachData hash];
  }
...
@interface IMSubscribeHttpSendMessageRequestBuilder()
@property (strong) IMSubscribeHttpSendMessageRequest* resultImsubscribeHttpSendMessageRequest;
@end

@implementation IMSubscribeHttpSendMessageRequestBuilder
@synthesize resultImsubscribeHttpSendMessageRequest;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultImsubscribeHttpSendMessageRequest = [[IMSubscribeHttpSendMessageRequest alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultImsubscribeHttpSendMessageRequest;
}
...
- (IMSubscribeHttpSendMessageRequestBuilder*) clone {
  return [IMSubscribeHttpSendMessageRequest builderWithPrototype:resultImsubscribeHttpSendMessageRequest];
}
- (IMSubscribeHttpSendMessageRequest*) defaultInstance {
  return [IMSubscribeHttpSendMessageRequest defaultInstance];
}
...
- (IMSubscribeHttpSendMessageRequest*) buildPartial {
  IMSubscribeHttpSendMessageRequest* returnMe = resultImsubscribeHttpSendMessageRequest;
  self.resultImsubscribeHttpSendMessageRequest = nil;
  return returnMe;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) mergeFrom:(IMSubscribeHttpSendMessageRequest*) other {
  if (other == [IMSubscribeHttpSendMessageRequest defaultInstance]) {
    return self;
  }
  if (other.hasSbUuid) {
  ...
  if (other.hasInfoid) {
    [self setInfoid:other.infoid];
  }
  if (other.userListArray.count > 0) {
    if (resultImsubscribeHttpSendMessageRequest.userListArray == nil) {
      resultImsubscribeHttpSendMessageRequest.userListArray = [other.userListArray copy];
    } else {
      [resultImsubscribeHttpSendMessageRequest.userListArray appendArray:other.userListArray];
    }
  }
  if (other.hasMsgType) {
    [self setMsgType:other.msgType];
  ...
  if (other.hasSbLoginid) {
    [self setSbLoginid:other.sbLoginid];
  }
  if (other.hasAttachData) {
    [self setAttachData:other.attachData];
  }
...
- (IMSubscribeHttpSendMessageRequestBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 26: {
        [self setInfoid:[input readString]];
        break;
      }
      case 32: {
        [self addUserList:[input readUInt64]];
        break;
      }
      case 40: {
        MsgType value = (MsgType)[input readEnum];
      ...
      case 64: {
        [self setSbLoginid:[input readUInt64]];
        break;
      }
      case 162: {
        [self setAttachData:[input readData]];
...
- (BOOL) hasSbUuid {
  return resultImsubscribeHttpSendMessageRequest.hasSbUuid;
}
- (NSString*) sbUuid {
  return resultImsubscribeHttpSendMessageRequest.sbUuid;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) setSbUuid:(NSString*) value {
  resultImsubscribeHttpSendMessageRequest.hasSbUuid = YES;
  resultImsubscribeHttpSendMessageRequest.sbUuid = value;
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) clearSbUuid {
  resultImsubscribeHttpSendMessageRequest.hasSbUuid = NO;
  resultImsubscribeHttpSendMessageRequest.sbUuid = @"";
  return self;
}
- (BOOL) hasSbId {
  return resultImsubscribeHttpSendMessageRequest.hasSbId;
}
- (UInt64) sbId {
  return resultImsubscribeHttpSendMessageRequest.sbId;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) setSbId:(UInt64) value {
  resultImsubscribeHttpSendMessageRequest.hasSbId = YES;
  resultImsubscribeHttpSendMessageRequest.sbId = value;
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) clearSbId {
  resultImsubscribeHttpSendMessageRequest.hasSbId = NO;
  resultImsubscribeHttpSendMessageRequest.sbId = 0L;
  return self;
}
- (BOOL) hasInfoid {
  return resultImsubscribeHttpSendMessageRequest.hasInfoid;
}
- (NSString*) infoid {
  return resultImsubscribeHttpSendMessageRequest.infoid;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) setInfoid:(NSString*) value {
  resultImsubscribeHttpSendMessageRequest.hasInfoid = YES;
  resultImsubscribeHttpSendMessageRequest.infoid = value;
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) clearInfoid {
  resultImsubscribeHttpSendMessageRequest.hasInfoid = NO;
  resultImsubscribeHttpSendMessageRequest.infoid = @"";
  return self;
}
- (PBAppendableArray *)userList {
  return resultImsubscribeHttpSendMessageRequest.userListArray;
}
- (UInt64)userListAtIndex:(NSUInteger)index {
  return [resultImsubscribeHttpSendMessageRequest userListAtIndex:index];
}
- (IMSubscribeHttpSendMessageRequestBuilder *)addUserList:(UInt64)value {
  if (resultImsubscribeHttpSendMessageRequest.userListArray == nil) {
    resultImsubscribeHttpSendMessageRequest.userListArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeUInt64];
  }
  [resultImsubscribeHttpSendMessageRequest.userListArray addUint64:value];
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder *)setUserListArray:(NSArray *)array {
  resultImsubscribeHttpSendMessageRequest.userListArray = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeUInt64];
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder *)setUserListValues:(const UInt64 *)values count:(NSUInteger)count {
  resultImsubscribeHttpSendMessageRequest.userListArray = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeUInt64];
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder *)clearUserList {
  resultImsubscribeHttpSendMessageRequest.userListArray = nil;
  return self;
}
- (BOOL) hasMsgType {
  return resultImsubscribeHttpSendMessageRequest.hasMsgType;
}
- (MsgType) msgType {
  return resultImsubscribeHttpSendMessageRequest.msgType;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) setMsgType:(MsgType) value {
  resultImsubscribeHttpSendMessageRequest.hasMsgType = YES;
  resultImsubscribeHttpSendMessageRequest.msgType = value;
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) clearMsgType {
  resultImsubscribeHttpSendMessageRequest.hasMsgType = NO;
  resultImsubscribeHttpSendMessageRequest.msgType = MsgTypeMsgTypeSingleText;
  return self;
}
- (BOOL) hasMsgData {
  return resultImsubscribeHttpSendMessageRequest.hasMsgData;
}
- (NSData*) msgData {
  return resultImsubscribeHttpSendMessageRequest.msgData;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) setMsgData:(NSData*) value {
  resultImsubscribeHttpSendMessageRequest.hasMsgData = YES;
  resultImsubscribeHttpSendMessageRequest.msgData = value;
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) clearMsgData {
  resultImsubscribeHttpSendMessageRequest.hasMsgData = NO;
  resultImsubscribeHttpSendMessageRequest.msgData = [NSData data];
  return self;
}
- (BOOL) hasGroupId {
  return resultImsubscribeHttpSendMessageRequest.hasGroupId;
}
- (NSString*) groupId {
  return resultImsubscribeHttpSendMessageRequest.groupId;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) setGroupId:(NSString*) value {
  resultImsubscribeHttpSendMessageRequest.hasGroupId = YES;
  resultImsubscribeHttpSendMessageRequest.groupId = value;
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) clearGroupId {
  resultImsubscribeHttpSendMessageRequest.hasGroupId = NO;
  resultImsubscribeHttpSendMessageRequest.groupId = @"";
  return self;
}
- (BOOL) hasSbLoginid {
  return resultImsubscribeHttpSendMessageRequest.hasSbLoginid;
}
- (UInt64) sbLoginid {
  return resultImsubscribeHttpSendMessageRequest.sbLoginid;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) setSbLoginid:(UInt64) value {
  resultImsubscribeHttpSendMessageRequest.hasSbLoginid = YES;
  resultImsubscribeHttpSendMessageRequest.sbLoginid = value;
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) clearSbLoginid {
  resultImsubscribeHttpSendMessageRequest.hasSbLoginid = NO;
  resultImsubscribeHttpSendMessageRequest.sbLoginid = 0L;
  return self;
}
- (BOOL) hasAttachData {
  return resultImsubscribeHttpSendMessageRequest.hasAttachData;
}
- (NSData*) attachData {
  return resultImsubscribeHttpSendMessageRequest.attachData;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) setAttachData:(NSData*) value {
  resultImsubscribeHttpSendMessageRequest.hasAttachData = YES;
  resultImsubscribeHttpSendMessageRequest.attachData = value;
  return self;
}
- (IMSubscribeHttpSendMessageRequestBuilder*) clearAttachData {
  resultImsubscribeHttpSendMessageRequest.hasAttachData = NO;
  resultImsubscribeHttpSendMessageRequest.attachData = [NSData data];
  return self;
}
@end

@interface IMSubscribeHttpSendMessageRespone ()
@property (strong) NSString* sbUuid;
@property UInt64 sbId;
@property (strong) NSMutableArray * sbmsgidListArray;
@property MsgType msgType;
@property (strong) NSData* msgData;
@property UInt32 createTime;
@property (strong) NSData* attachData;
...
@implementation IMSubscribeHttpSendMessageRespone
...
static IMSubscribeHttpSendMessageRespone* defaultIMSubscribeHttpSendMessageResponeInstance = nil;
+ (void) initialize {
  if (self == [IMSubscribeHttpSendMessageRespone class]) {
    defaultIMSubscribeHttpSendMessageResponeInstance = [[IMSubscribeHttpSendMessageRespone alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultIMSubscribeHttpSendMessageResponeInstance;
}
- (instancetype) defaultInstance {
  return defaultIMSubscribeHttpSendMessageResponeInstance;
}
- (NSArray *)sbmsgidList {
  return sbmsgidListArray;
}
- (SubsribeMsgIdInfo*)sbmsgidListAtIndex:(NSUInteger)index {
  return [sbmsgidListArray objectAtIndex:index];
}
- (BOOL) isInitialized {
  if (!self.hasSbUuid) {
    return NO;
  ...
  __block BOOL isInitsbmsgidList = YES;
   [self.sbmsgidList enumerateObjectsUsingBlock:^(SubsribeMsgIdInfo *element, NSUInteger idx, BOOL *stop) {
    if (!element.isInitialized) {
      isInitsbmsgidList = NO;
      *stop = YES;
    }
  }];
  if (!isInitsbmsgidList) return isInitsbmsgidList;
  return YES;
}
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  if (self.hasSbUuid) {
  ...
  [self.sbmsgidListArray enumerateObjectsUsingBlock:^(SubsribeMsgIdInfo *element, NSUInteger idx, BOOL *stop) {
    [output writeMessage:3 value:element];
  }];
  if (self.hasMsgType) {
  ...
  if (self.hasCreateTime) {
    [output writeUInt32:6 value:self.createTime];
  }
  if (self.hasAttachData) {
    [output writeData:20 value:self.attachData];
  }
...
- (SInt32) serializedSize {
  ...
  if (self.hasCreateTime) {
    size_ += computeUInt32Size(6, self.createTime);
  }
  if (self.hasAttachData) {
    size_ += computeDataSize(20, self.attachData);
  }
...
+ (IMSubscribeHttpSendMessageRespone*) parseFromData:(NSData*) data {
  return (IMSubscribeHttpSendMessageRespone*)[[[IMSubscribeHttpSendMessageRespone builder] mergeFromData:data] build];
}
+ (IMSubscribeHttpSendMessageRespone*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMSubscribeHttpSendMessageRespone*)[[[IMSubscribeHttpSendMessageRespone builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (IMSubscribeHttpSendMessageRespone*) parseFromInputStream:(NSInputStream*) input {
  return (IMSubscribeHttpSendMessageRespone*)[[[IMSubscribeHttpSendMessageRespone builder] mergeFromInputStream:input] build];
}
+ (IMSubscribeHttpSendMessageRespone*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMSubscribeHttpSendMessageRespone*)[[[IMSubscribeHttpSendMessageRespone builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMSubscribeHttpSendMessageRespone*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (IMSubscribeHttpSendMessageRespone*)[[[IMSubscribeHttpSendMessageRespone builder] mergeFromCodedInputStream:input] build];
}
+ (IMSubscribeHttpSendMessageRespone*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMSubscribeHttpSendMessageRespone*)[[[IMSubscribeHttpSendMessageRespone builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMSubscribeHttpSendMessageResponeBuilder*) builder {
  return [[IMSubscribeHttpSendMessageResponeBuilder alloc] init];
}
+ (IMSubscribeHttpSendMessageResponeBuilder*) builderWithPrototype:(IMSubscribeHttpSendMessageRespone*) prototype {
  return [[IMSubscribeHttpSendMessageRespone builder] mergeFrom:prototype];
}
- (IMSubscribeHttpSendMessageResponeBuilder*) builder {
  return [IMSubscribeHttpSendMessageRespone builder];
}
- (IMSubscribeHttpSendMessageResponeBuilder*) toBuilder {
  return [IMSubscribeHttpSendMessageRespone builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasSbUuid) {
    [output appendFormat:@"%@%@: %@\n", indent, @"sbUuid", self.sbUuid];
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  for (SubsribeMsgIdInfo* element in self.sbmsgidListArray) {
    NSMutableDictionary *elementDictionary = [NSMutableDictionary dictionary];
    [element storeInDictionary:elementDictionary];
    [dictionary setObject:[NSDictionary dictionaryWithDictionary:elementDictionary] forKey:@"sbmsgidList"];
  }
  if (self.hasMsgType) {
    [dictionary setObject: @(self.msgType) forKey: @"msgType"];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[IMSubscribeHttpSendMessageRespone class]]) {
    return NO;
  }
  IMSubscribeHttpSendMessageRespone *otherMessage = other;
  return
      self.hasSbUuid == otherMessage.hasSbUuid &&
      (!self.hasSbUuid || [self.sbUuid isEqual:otherMessage.sbUuid]) &&
      self.hasSbId == otherMessage.hasSbId &&
      (!self.hasSbId || self.sbId == otherMessage.sbId) &&
      [self.sbmsgidListArray isEqualToArray:otherMessage.sbmsgidListArray] &&
      self.hasMsgType == otherMessage.hasMsgType &&
      (!self.hasMsgType || self.msgType == otherMessage.msgType) &&
      self.hasMsgData == otherMessage.hasMsgData &&
      (!self.hasMsgData || [self.msgData isEqual:otherMessage.msgData]) &&
...
@interface IMSubscribeHttpSendMessageResponeBuilder()
@property (strong) IMSubscribeHttpSendMessageRespone* resultImsubscribeHttpSendMessageRespone;
@end

@implementation IMSubscribeHttpSendMessageResponeBuilder
@synthesize resultImsubscribeHttpSendMessageRespone;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultImsubscribeHttpSendMessageRespone = [[IMSubscribeHttpSendMessageRespone alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultImsubscribeHttpSendMessageRespone;
}
...
- (IMSubscribeHttpSendMessageResponeBuilder*) clone {
  return [IMSubscribeHttpSendMessageRespone builderWithPrototype:resultImsubscribeHttpSendMessageRespone];
}
- (IMSubscribeHttpSendMessageRespone*) defaultInstance {
  return [IMSubscribeHttpSendMessageRespone defaultInstance];
}
...
- (IMSubscribeHttpSendMessageRespone*) buildPartial {
  IMSubscribeHttpSendMessageRespone* returnMe = resultImsubscribeHttpSendMessageRespone;
  self.resultImsubscribeHttpSendMessageRespone = nil;
  return returnMe;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) mergeFrom:(IMSubscribeHttpSendMessageRespone*) other {
  if (other == [IMSubscribeHttpSendMessageRespone defaultInstance]) {
    return self;
  }
  if (other.hasSbUuid) {
    [self setSbUuid:other.sbUuid];
  ...
  if (other.sbmsgidListArray.count > 0) {
    if (resultImsubscribeHttpSendMessageRespone.sbmsgidListArray == nil) {
      resultImsubscribeHttpSendMessageRespone.sbmsgidListArray = [[NSMutableArray alloc] initWithArray:other.sbmsgidListArray];
    } else {
      [resultImsubscribeHttpSendMessageRespone.sbmsgidListArray addObjectsFromArray:other.sbmsgidListArray];
    }
  }
  if (other.hasMsgType) {
    [self setMsgType:other.msgType];
...
- (IMSubscribeHttpSendMessageResponeBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 26: {
        SubsribeMsgIdInfoBuilder* subBuilder = [SubsribeMsgIdInfo builder];
        [input readMessage:subBuilder extensionRegistry:extensionRegistry];
        [self addSbmsgidList:[subBuilder buildPartial]];
        break;
      }
      case 32: {
        MsgType value = (MsgType)[input readEnum];
...
- (BOOL) hasSbUuid {
  return resultImsubscribeHttpSendMessageRespone.hasSbUuid;
}
- (NSString*) sbUuid {
  return resultImsubscribeHttpSendMessageRespone.sbUuid;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) setSbUuid:(NSString*) value {
  resultImsubscribeHttpSendMessageRespone.hasSbUuid = YES;
  resultImsubscribeHttpSendMessageRespone.sbUuid = value;
  return self;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) clearSbUuid {
  resultImsubscribeHttpSendMessageRespone.hasSbUuid = NO;
  resultImsubscribeHttpSendMessageRespone.sbUuid = @"";
  return self;
}
- (BOOL) hasSbId {
  return resultImsubscribeHttpSendMessageRespone.hasSbId;
}
- (UInt64) sbId {
  return resultImsubscribeHttpSendMessageRespone.sbId;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) setSbId:(UInt64) value {
  resultImsubscribeHttpSendMessageRespone.hasSbId = YES;
  resultImsubscribeHttpSendMessageRespone.sbId = value;
  return self;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) clearSbId {
  resultImsubscribeHttpSendMessageRespone.hasSbId = NO;
  resultImsubscribeHttpSendMessageRespone.sbId = 0L;
  return self;
}
- (NSMutableArray *)sbmsgidList {
  return resultImsubscribeHttpSendMessageRespone.sbmsgidListArray;
}
- (SubsribeMsgIdInfo*)sbmsgidListAtIndex:(NSUInteger)index {
  return [resultImsubscribeHttpSendMessageRespone sbmsgidListAtIndex:index];
}
- (IMSubscribeHttpSendMessageResponeBuilder *)addSbmsgidList:(SubsribeMsgIdInfo*)value {
  if (resultImsubscribeHttpSendMessageRespone.sbmsgidListArray == nil) {
    resultImsubscribeHttpSendMessageRespone.sbmsgidListArray = [[NSMutableArray alloc]init];
  }
  [resultImsubscribeHttpSendMessageRespone.sbmsgidListArray addObject:value];
  return self;
}
- (IMSubscribeHttpSendMessageResponeBuilder *)setSbmsgidListArray:(NSArray *)array {
  resultImsubscribeHttpSendMessageRespone.sbmsgidListArray = [[NSMutableArray alloc]initWithArray:array];
  return self;
}
- (IMSubscribeHttpSendMessageResponeBuilder *)clearSbmsgidList {
  resultImsubscribeHttpSendMessageRespone.sbmsgidListArray = nil;
  return self;
}
- (BOOL) hasMsgType {
  return resultImsubscribeHttpSendMessageRespone.hasMsgType;
}
- (MsgType) msgType {
  return resultImsubscribeHttpSendMessageRespone.msgType;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) setMsgType:(MsgType) value {
  resultImsubscribeHttpSendMessageRespone.hasMsgType = YES;
  resultImsubscribeHttpSendMessageRespone.msgType = value;
  return self;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) clearMsgType {
  resultImsubscribeHttpSendMessageRespone.hasMsgType = NO;
  resultImsubscribeHttpSendMessageRespone.msgType = MsgTypeMsgTypeSingleText;
  return self;
}
- (BOOL) hasMsgData {
  return resultImsubscribeHttpSendMessageRespone.hasMsgData;
}
- (NSData*) msgData {
  return resultImsubscribeHttpSendMessageRespone.msgData;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) setMsgData:(NSData*) value {
  resultImsubscribeHttpSendMessageRespone.hasMsgData = YES;
  resultImsubscribeHttpSendMessageRespone.msgData = value;
  return self;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) clearMsgData {
  resultImsubscribeHttpSendMessageRespone.hasMsgData = NO;
  resultImsubscribeHttpSendMessageRespone.msgData = [NSData data];
  return self;
}
- (BOOL) hasCreateTime {
  return resultImsubscribeHttpSendMessageRespone.hasCreateTime;
}
- (UInt32) createTime {
  return resultImsubscribeHttpSendMessageRespone.createTime;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) setCreateTime:(UInt32) value {
  resultImsubscribeHttpSendMessageRespone.hasCreateTime = YES;
  resultImsubscribeHttpSendMessageRespone.createTime = value;
  return self;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) clearCreateTime {
  resultImsubscribeHttpSendMessageRespone.hasCreateTime = NO;
  resultImsubscribeHttpSendMessageRespone.createTime = 0;
  return self;
}
- (BOOL) hasAttachData {
  return resultImsubscribeHttpSendMessageRespone.hasAttachData;
}
- (NSData*) attachData {
  return resultImsubscribeHttpSendMessageRespone.attachData;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) setAttachData:(NSData*) value {
  resultImsubscribeHttpSendMessageRespone.hasAttachData = YES;
  resultImsubscribeHttpSendMessageRespone.attachData = value;
  return self;
}
- (IMSubscribeHttpSendMessageResponeBuilder*) clearAttachData {
  resultImsubscribeHttpSendMessageRespone.hasAttachData = NO;
  resultImsubscribeHttpSendMessageRespone.attachData = [NSData data];
  return self;
}
@end
