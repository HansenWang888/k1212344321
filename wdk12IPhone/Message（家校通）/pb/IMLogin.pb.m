...
- (IMDeviceTokenReqBuilder*) clearUserId {
  ...
  resultImdeviceTokenReq.userId = 0L;
  return self;
}
- (BOOL) hasDeviceToken {
...
- (IMDeviceTokenRspBuilder*) clearUserId {
  ...
  resultImdeviceTokenRsp.userId = 0L;
  return self;
}
- (BOOL) hasAttachData {
...
- (IMKickPCClientReqBuilder*) clearUserId {
  ...
  resultImkickPcclientReq.userId = 0L;
  return self;
}
@end
...
- (IMKickPCClientRspBuilder*) clearUserId {
  ...
  resultImkickPcclientRsp.userId = 0L;
  return self;
}
- (BOOL) hasResultCode {
