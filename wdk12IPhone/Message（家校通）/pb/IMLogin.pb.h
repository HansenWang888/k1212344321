...
- (BOOL) hasUserId;
- (UInt64) userId;
- (IMKickUserBuilder*) setUserId:(UInt64) value;
...
- (BOOL) hasUserId;
- (UInt64) userId;
- (IMDeviceTokenReqBuilder*) setUserId:(UInt64) value;
...
- (BOOL) hasUserId;
- (UInt64) userId;
- (IMDeviceTokenRspBuilder*) setUserId:(UInt64) value;
...
- (BOOL) hasUserId;
- (UInt64) userId;
- (IMKickPCClientReqBuilder*) setUserId:(UInt64) value;
...
- (BOOL) hasUserId;
- (UInt64) userId;
- (IMKickPCClientRspBuilder*) setUserId:(UInt64) value;
