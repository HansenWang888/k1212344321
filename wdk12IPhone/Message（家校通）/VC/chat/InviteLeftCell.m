...
@implementation InviteLeftCell

- (void)awakeFromNib {
    UIImageView *imgV = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ReceiverText_bj"]];
