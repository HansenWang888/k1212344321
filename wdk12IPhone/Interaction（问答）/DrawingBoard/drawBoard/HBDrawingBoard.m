...
@property (nonatomic, copy) drawedImageBlock drawedImageBlock;
...
- (void)saveCurrentImageToAlbum
{
    ...
    if (self.drawedImageBlock) {
        self.drawedImageBlock(getImage);
    }
}

- (void)getDrawedImage:(drawedImageBlock)drawedImageBlock {
    self.drawedImageBlock = drawedImageBlock;
}
